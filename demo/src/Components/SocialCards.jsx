    ...
    <div className="container Scontainer">
        <div className="card">
          ...
          <div className="face face2">
            <div className="content">
              <h3>
                <a className='soA' href="https://www.instagram.com/app201_for_programing/" target="_blank" rel="noreferrer">App201</a>
              </h3>
        ...
        <div className="card">
          ...
          <div className="face face2">
            <div className="content">
              <h3>
                <a className='soA' href="https://www.facebook.com/com.App201" target="_blank" rel="noreferrer">App201</a>
              </h3>
        ...
        <div className="card">
          ...
          <div className="face face2">
            <div className="content">
              <h3>
                <a className='soA' href="https://www.linkedin.com/company/app201/" target="_blank" rel="noreferrer">App201</a>
              </h3>
